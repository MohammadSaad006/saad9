...
function setup() {
 ...
 wall1.visible=false
  player=createSprite(0,20,10,10)
  ...
  text("GAMEOVER Your Mission Faild",200,20)
...
if (gameState==="START"){
  ...
  textSize(20)
  fill(255,0,0)
  text("Start press on GreenButton",200,350)
  ...
  text("Story:-",300,20)
  text("Your Mission is Collect vaccino and save from coronavirus and  ",0,50)
  text("in last of game one vaccino after collect vaccino game will be Finish",0,80)
  textSize(20)
  fill(255,0,0)
  text("How To Play :-",300,200)
  text("Right:-right Arrow  ",300,240)
  text("Left:-Left Aroow",300,260)
  text("Jump:-Space",300,280)
